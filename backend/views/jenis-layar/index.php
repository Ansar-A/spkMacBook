                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="jenis-layar-index">
                            <div class="row">
                                <div class="col-sm-5">
                                    <?= Html::button('<i class="md-add-box"></i> Add Data', ['value' => Url::to(['jenis-layar/create']), 'class' => 'btn btn-success', 'id' => 'modalButton']) ?>
                                </div>
                                <div class="col-sm-7">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="product-right-info">
                                                    ...
                                                    <hr>
                                                    <h5 class="font-600" style="padding-left: 5px;">Layar Description</h5>
                                                    <p class="text-muted" style="padding-left: 5px;">Layar 13,3 inci (diagonal) dengan lampu latar LED dan teknologi IPS; resolusi 2560 x 1600 pada 227 piksel per inci dengan dukungan untuk jutaan warna Kecerahan 500 nit Warna luas (P3) Teknologi True Tone</p>
                                                    <div class="m-t-30 text-center">
                                                        <a href="https://www.apple.com/id/macbook-pro-13/specs/" target="_blank" class="btn btn-info waves-effect waves-light btn-sm">
