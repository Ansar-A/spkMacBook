                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="audio-index">
                            <div class="row">
                                <div class="col-sm-5">
                                    <?= Html::button('<i class="md-add-box"></i> Add Data', ['value' => Url::to(['audio/create']), 'class' => 'btn btn-success', 'id' => 'modalButton']) ?>
                                </div>
                                        ...
                                        [
                                            ...
                                            'buttons' => [
                                                ...
                                                'view' => function ($url, $model) {
                                                    return Html::a('', ['view', 'id_audio' => $model->id_audio], [
                                                        'class' => 'btn btn-icon waves-effect waves-light btn-info btn-sm glyphicon glyphicon-eye-open'
                                                    ]);
                                                },
                                                'update' => function ($url, $model) {

                                                    return Html::a('', ['update', 'id_audio' => $model->id_audio], ['class' => 'btn btn-icon waves-effect waves-light btn-primary btn-sm glyphicon glyphicon-pencil']);
                                                },
                                                'delete' => function ($url, $model) {

                                                    return Html::a('', ['delete', 'id_audio' => $model->id_audio], [
