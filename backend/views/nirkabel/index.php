                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="nirkabel-index">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <?= Html::button('<i class="md-add-box"></i> Add Data', ['value' => Url::to(['nirkabel/create']), 'class' => 'btn btn-success', 'id' => 'modalButton']) ?>
                                    </div>
                                            ...
                                            [
                                                ...
                                                'buttons' => [
                                                    ...
                                                    'update' => function ($url, $model) {
                                                        ...
                                                        return Html::a('', ['update', 'id_nirkabel' => $model->id_nirkabel], ['class' => 'btn btn-icon waves-effect waves-light btn-primary btn-sm glyphicon glyphicon-pencil']);
                                                    },
                                                    'delete' => function ($url, $model) {

                                                        return Html::a('', ['delete', 'id_nirkabel' => $model->id_nirkabel], [
