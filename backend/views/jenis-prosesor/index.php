        ...
        <div class="row">
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?= Url::to(['jenis-prosesor/index']) ?>">Prosesor</a>
                    </li>
                    <li class="active">
                        Index
                    </li>
            ...
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="jenis-prosesor-index">
                        <div class="row">
                            <div class="col-sm-5 ">
                                <?= Html::button('<i class="md-add-box"></i> Add Data', ['value' => Url::to(['jenis-prosesor/create']), 'class' => 'btn btn-success', 'id' => 'modalButton']) ?>
                            </div>
