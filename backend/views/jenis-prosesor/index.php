        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="jenis-prosesor-index">
                    ...
                    <div class="row">
                        <div class="col-sm-9">
                            <?= Html::button('<i class="md-add-box"></i> Create Jenis Prosesor', ['value' => Url::to(['jenis-prosesor/create']), 'class' => 'btn btn-success ', 'id' => 'modalButton']) ?>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <?= GridView::widget([
                        ...
                        'panel' => [
                            ...
                            'type' => 'default',
                            //'before' => Html::a('<i class="md-add-box"></i> Create Jenis Prosesor', ['create'], ['class' => 'btn btn-success']),
