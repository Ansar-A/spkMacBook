...
class Produk extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_prosesor' => 'Id Prosesor',
            'id_so' => 'Sistem Operasi',
            'id_layar' => 'Id Layar',
            'id_penyimpanan' => 'Id Penyimpanan',
            'get_warna' => 'Get Warna',
            'get_daya' => 'Get Daya',
            'get_nirkabel' => 'Get Nirkabel',
            'get_ukuranberat' => 'Get Ukuranberat',
            'get_kamera' => 'Get Kamera',
            'get_builtinApps' => 'Get Builtin Apps',
            'get_audio' => 'Get Audio',
            'get_koneksiekspansi' => 'Get Koneksiekspansi',
            'photo' => 'Photo',
            'harga' => 'Harga',
            'get_detaill' => 'Get Detaill',
        ];
    }
